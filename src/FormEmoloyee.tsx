...
export default class EmployeeFormCustom extends React.Component<IFormContainerProps, IFormContainerState> {
    ...
    public componentDidMount(): void {
        ...
        if (itemID !== undefined) {
            ...
            // const pbsTerms = item.PBS ? [{
            //     labels: [{
            //         name: item.PBS.Label,
            //         isDefault: true,
            //         languageTag: 'en-US'
            //     }],
            //     id: item.PBS.TermGuid
            // }] : [];
            ...
            this.setState({
                ...
                joiningDate: item.StartDate1 ? item.StartDate1.split('T')[0] : "", // Extract only the date part
                pbsTerms: this.createTaxonomyTerm(item.PBS), // Set PBS terms
            });
        }
    }
                                                ...
                                                >
                                                    <TooltipHost content="PBS" delay={TooltipDelay.long}>
                                                        <ModernTaxonomyPicker
                                                            ...
                                                            allowMultipleSelections={false}
                                                            termSetId="835ea10a-aa6e-4fbb-b833-58e85ff8f6be" // Replace with the actual TermSet ID for PBS
