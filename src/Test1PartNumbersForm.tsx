...
class Test1PartNumbersForm extends React.Component<{}, State> {
  constructor(props: {}) {
    super(props);
    this.state = {
  ...
  // Concatenate parts to show in the multi-line text box
  ...
  handleSubmit = () => {
    ...
    const formattedValue = this.getMultiLineText();
  ...
  render() {
    ...
    return (
      <div>
        ...
        {/* Multi-line text box showing the concatenated values */}
        <textarea
          value={this.getMultiLineText()}
          readOnly
          rows={5}
...
export default Test1PartNumbersForm;
