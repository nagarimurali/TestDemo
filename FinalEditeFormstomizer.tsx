...
export default class EmployeeFormCustom extends React.Component<IFormContainerProps, IFormContainerState> {
    ...
    public render(): React.ReactElement<{}> {
        ...
        const { pbsTerms, fieldInfos } = this.state;
        return (
                                    ...
                                    <div className={styles.column}>
                                        <div className={styles.row}>
                                            <div className={styles.fieldWrapper}>
                                                ...
                                                >
                                                    <TooltipHost content="ABS" delay={TooltipDelay.long}>
                                                        {fieldInfos && <ModernTaxonomyPicker
                                            ...
                                            <div className={styles.fieldWrapper}>
                                                ...
                                                <div className={styles.fieldWrapper}>
                                                    <TooltipHost content="Section" delay={TooltipDelay.long}>
...
> {
    public render(): React.ReactElement<IBaselineCommandBarProps> {
        const { displayMode, onSave, onCancel } = this.props;

        const commandBarItems: ICommandBarItemProps[] = displayMode === FormDisplayMode.Display
            ? [
                {
                    key: "cancel",
                    text: "Cancel",
